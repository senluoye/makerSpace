...
//        return newEnterpriseService.getOldForm();
    ...
    private Map<String, Object> newRegister(@RequestPart MultipartFile file, @RequestPart Map<String, Object> map) {
        if (file.isEmpty()) {
    ...
    private Map<String, Object> newApplyForMakerSpace(@RequestBody Map<String, Object> map) {
        return newEnterpriseService.NewApplyForMakerSpace(map);
    }
